...
TROCR_BASE_MODEL = "magistermilitum/tridis_HTR"
...
# Note: max_length est utilisé à la place de max_new_tokens pour éviter le conflit
# avec la config par défaut du modèle TrOCR (max_length=200)
